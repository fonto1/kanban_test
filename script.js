    ...
    .then((data1) => {
        ...
        */
        ...
        function push(evt) {
            ...
            let currentValue = getEl(id).innerText // value
            let fromTarget = getEl(id).parentElement.id // from id
        ...
        let login_but = getEl("login_button")
        ...
        function ready() {
            let user = [];
            let inputUser = getEl("username");
            let inputPass = getEl("userpass")
            console.log(dataSet1);
            ...
            if (user[0] == inputUser.value && user[1] == inputPass.value) {
                display();
                getEl("userScreen").style.display = 'block';
        ...
        function logout1() {
            ...
            display();
            getEl("userScreen").style.display = 'none';
